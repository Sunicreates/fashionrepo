...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "glass-card rounded-3xl shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-light text-2xl leading-none tracking-tight text-gray-700", className)}
    {...props}
  />
))
